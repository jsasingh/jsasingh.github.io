...
$(document).ready(function() {
    $('#pagepiling').pagepiling({
        ...
        menu: '#menu',
        anchors: ['welcome', 'aboutMe', 'skills', 'experience','websitePlatforms', 'WhatIDo',  'contactMe'],
        sectionsColor: ['#2ebe21', '#2C3E50', '#51bec4','#2ebe21', '#2C3E50', '#39C','#2ebe21'],
        loopTop: true,
        loopBottom: true
    });
...
var canvasDiv = document.getElementById('welcome');
var options = { 
  interactive: true,
  speed: 'slow',
  density: 'high',
